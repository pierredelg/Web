...
public class SelectSimple extends HttpServlet {
    public void doGet(HttpServletRequest req, HttpServletResponse res ) {
        ...
        String url = getServletContext().getInitParameter("urlBDD");
        String nom = getServletContext().getInitParameter("loginBDD");
        String mdp = getServletContext().getInitParameter("mdpBDD");
        String driver = getServletContext().getInitParameter("driverBDD");
